...
print("Mean, median and mode of reading scores is {}, {} and {} respectively".format(reading_mean,reading_median, reading_mode))
print("Mean, median and mode of writing scores is {}, {} and {} respectively".format(writing_mean,writing_median, writing_mode))
